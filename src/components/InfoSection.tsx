...
function InfoSection() {
    ...
    return (
        <div className='text-white bg-gradient-to-t from-transparent to-blue-900 max-w-[1940px] select-none mt-[-96px] w-full h-full mx-auto text-center flex flex-col justify-center'>
